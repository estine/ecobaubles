...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 385.240730881690979, 353.333324909210205, 74.0, 56.0 ],
					"setminmax" : [ 0.0, 100.0 ],
					"setstyle" : 5
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 300.833326160907745, 353.333324909210205, 74.0, 56.0 ],
					"setminmax" : [ 0.0, 100.0 ],
					"setstyle" : 5
				}
...
,
						...
						"gridsize" : [ 15.0, 15.0 ],
						"title" : "multi-species_predator-prey_model",
						"boxes" : [ 							{
								"box" : 								{
									"id" : "obj-22",
									"maxclass" : "comment",
...
,
					"patching_rect" : [ 709.629606366157532, 291.851842284202576, 265.0, 22.0 ],
					"rnboattrcache" : 					{
...
,
						"snapshotlist" : 						{
							...
							"entries" : [ 								{
									...
									"version" : 2,
									"minorversion" : 0,
									"name" : "multi-species_predator-prey_model",
									"origin" : "multi-species_predator-prey_model",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "multi-species_predator-prey_model",
										"filename" : "multi-species_predator-prey_model.maxsnap",
										"filepath" : "~/Documents/Max 9/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "e61f95f06d4afa4a59dce08d149b0fcd"
									}
...
,
					"text" : "rnbo~ @title multi-species_predator-prey_model",
					"varname" : "rnbo~[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 711.851828515529633, -23.703702926635742, 150.0, 20.0 ],
					"text" : "Multi-agent"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1108.148111820220947, -99.999996721744537, 1274.390274286270142, 1136.585392951965332 ]
				}
...
,
					"snapshot" : 					{
						...
						"embed" : 1,
						"snapshot" : 						{
							"__presetid" : "predator-prey_model"
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20250511.maxsnap",
										"filepath" : "~/Documents/Max 9/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "561e9dd9851115a1264b70c3a50b224b"
									}
...
,
					"text" : "rnbo~ @title predator-prey_model",
					"varname" : "rnbo~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.0, 83.0, 150.0, 186.0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "multi-species_predator-prey_model.maxsnap",
...
, 			{
				"name" : "untitled_20250511.maxsnap",
				"bootpath" : "~/Documents/Max 9/Snapshots",
				"patcherrelativepath" : "../../../../Max 9/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
